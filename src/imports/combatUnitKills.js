...
let path = '/import/combat/unitkills';

function importCombatUnitKills(player, data) {
...
router.bind(path, function(req, client){
    try {
        await importCombatUnitKills(req.inGameName, req.data);
    } catch(err){
...
module.exports = {
    importCombatUnitKills: importCombatUnitKills,
}