...
let path = '/import/empire/defense';

function importEmpireDefense(player, data) {
...
router.bind(path, function(req, client){
    try {
        await importEmpireDefense(req.inGameName, req.data);
    } catch(err){
...
module.exports = {
    importEmpireDefense: importEmpireDefense,
}