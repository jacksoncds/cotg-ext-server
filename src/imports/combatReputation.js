...
let path = '/import/combat/reputation';

function importCombatReputation(player, data) {
...
router.bind(path, function(req, client){
    try {
        await importCombatReputation(req.inGameName, req.data);
    } catch(err){
...
module.exports = {
    importCombatReputation: importCombatReputation,
}