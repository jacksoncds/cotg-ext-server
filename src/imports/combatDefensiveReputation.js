...
let path = '/import/combat/defensivereputation';

function importCombatDefensiveReputation(player, data) {
...
router.bind(path, function (req, client) {
    try {
        var result = await importCombatDefensiveReputation(req.inGameName, req.data);
    } catch (err) {
...
module.exports = {
    importCombatDefensiveReputation: importCombatDefensiveReputation,
}