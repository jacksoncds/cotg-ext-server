...
let path = '/import/raiding/bosses';

function importRaidingBosses(player, data) {
...
router.bind(path, function(req, client){
    try {
        await importRaidingBosses(req.inGameName, req.data);
    } catch(err){
...
module.exports = {
    importRaidingBosses: importRaidingBosses,
}