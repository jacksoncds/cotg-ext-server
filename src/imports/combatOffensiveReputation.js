...
let path = '/import/combat/offensivereputation';

function importCombatOffensiveReputation(player, data) {
...
router.bind(path, function(req, client){
    try {
        await importCombatOffensiveReputation(req.inGameName, req.data);
    } catch(err){
...
module.exports = {
    importCombatOffensiveReputation: importCombatOffensiveReputation,
}