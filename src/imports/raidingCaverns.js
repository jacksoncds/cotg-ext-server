...
let path = '/import/raiding/caverns';

function importRaidingCaverns(player, data) {
...
router.bind(path, function(req, client){
    try {
        await importRaidingCaverns(req.inGameName, req.data);
    } catch(err){
...
module.exports = {
    importRaidingCaverns: importRaidingCaverns,
}